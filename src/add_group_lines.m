% add_group_lines(networks) draws boundaries on a plot at the specified
% intervals. The input variable, 'groups', is a 1 x n integer matrix  which
% specifies how many components are in each cluster. For example, 
% add_group_lines([3 3 3]) would draw lines at 3 and 6 components 
